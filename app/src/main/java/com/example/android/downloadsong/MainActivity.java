package com.example.android.downloadsong;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Download_Uri = Uri.parse("http://www.feelthetour.com/Suja/Song1.mp3");
    ...
    /*   btnMultiple.setOnClickListener(new View.OnClickListener() {
        ...
        btnSingle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                request.setDescription("Downloading " + "Song" + ".mp3");

                request.setVisibleInDownloadsUi(true);

                request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "/Sujabrata/" + "/" + "Sample" + ".mp3");
